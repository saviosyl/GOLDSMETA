    ...
    res.json({
      ...
      stablePlan: sessionPlan
        ? {
            ...
            oneHourBiasSourceTime: sessionPlan.oneHourBiasSourceTime,
            oneHourBiasConfirmed: sessionPlan.oneHourBiasConfirmed,
            oneHourBiasState: sessionPlan.oneHourBiasState,
