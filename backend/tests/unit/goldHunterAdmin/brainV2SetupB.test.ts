...
const m1Eligible: M1CandleFlowEvaluation = {
  ...
  retracementPct: 32,
  baseHoldTicks: 3,
  baseHoldDurationMs: 1500,
  continuationBreakLevel: 2600.2,
  currentCandleStartMs: 1_000_000,
  currentCandleAgeSec: 20,
  currentM1Open: 2599.9,
  currentM1High: 2601.2,
  currentM1Low: 2599.6,
  currentM1Displacement: 0.3,
  signalRange: 2.2,
  medianRange5: 2.0,
  directionalDisplacement: 0.5,
  remainingExpectedRange: 1.5,
  recentNoise: 0.25,
  remainingMovementBudget: 1.5,
  pullbackRatio: 0.3,
  reclaimDistance: 0.35,
  pulseHealthAtEntry: 74,
  entryQuality: 0.86,
