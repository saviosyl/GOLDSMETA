...
const ROOT = process.env.GM_AUDIT_OUT || "/workspace/docs/ui/premium-production";
const BASE = "https://goldmeta.metamechsolutions.com";
const BUILD = "2a1fc27029beccf3e1a9621a5ac4b9e5aaebe2bd";
...
const USER_PAGES = [
  ...
  { n: "02", slug: "autotrade", route: "/autotrade", name: "AutoTrade" },
  { n: "03", slug: "markets", route: "/intelligence", name: "Markets" },
  { n: "04", slug: "journal", route: "/journal", name: "Journal" },
  { n: "05", slug: "insights-performance", route: "/insights/performance", name: "Insights / Performance" },
  { n: "06", slug: "insights-signals", route: "/insights/signals", name: "Insights / Signals" },
  { n: "07", slug: "insights-strategy", route: "/insights/strategy", name: "Insights / Strategy" },
  { n: "08", slug: "history-replay", route: "/history-replay/history", name: "History & Replay" },
  { n: "09", slug: "replay", route: "/history-replay/replay", name: "Replay" },
  { n: "10", slug: "levels", route: "/levels", name: "Levels" },
  { n: "11", slug: "risk-planner", route: "/planner", name: "Risk Planner" },
  { n: "12", slug: "broker", route: "/brokers", name: "Broker" },
  { n: "13", slug: "alerts", route: "/alerts", name: "Alerts" },
  { n: "14", slug: "settings", route: "/settings", name: "Settings" },
  { n: "15", slug: "help", route: "/help", name: "Help" },
  { n: "16", slug: "analysis", route: "/analysis", name: "Analysis" },
  { n: "17", slug: "tradingview-setup", route: "/tradingview", name: "TradingView Setup" },
  { n: "18", slug: "research", route: "/v4", name: "Research Lab" }
];
...
async function openMobileMore(page) {
  const candidates = [
    ...
    page.getByTestId("mobile-more-btn"),
...
async function findFirstHistoryDetail(page) {
  await page.goto(`${BASE}/history-replay/history`, { waitUntil: "networkidle", timeout: 90_000 });
...
async function main() {
  ...
  await page.goto(`${BASE}/history-replay/history`, { waitUntil: "domcontentloaded", timeout: 90_000 });
  await settle(page, "/history");
  try {
