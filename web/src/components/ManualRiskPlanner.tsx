...
export function ManualRiskPlanner({ risk, setup = null, suppressed = false }: Props) {
  ...
  return (
    <section
      className={`card manual-risk-planner ${suppressed ? "suppressed" : ""}`}
    ...
    >
      ...
      <div className="grid-2 compact-metrics" data-testid="risk-estimates">
      ...
      <p className="muted estimate-note">* Estimate only — confirm in your broker ticket.</p>
