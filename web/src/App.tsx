...
const MicroEdgeConnectCallbackPage = lazy(() => import("./pages/MicroEdgeConnectCallbackPage").then((m) => ({ default: m.MicroEdgeConnectCallbackPage })));
...
const GoldHunterTestConsolePage = lazy(() => import("./pages/goldHunter/GoldHunterTestConsolePage").then((m) => ({ default: m.GoldHunterTestConsolePage })));
      ...
      <QuoteProvider>
        ...
        <AppShell>
          <Routes>
            ...
            <Route path="/micro-edge/connect/callback" element={<LazyRoute label="Micro Edge Connect"><MicroEdgeConnectCallbackPage /></LazyRoute>} />
            ...
            <Route path="/gold-hunter-test" element={<LazyRoute label="Gold Hunter Test Console"><GoldHunterTestConsolePage /></LazyRoute>} />
